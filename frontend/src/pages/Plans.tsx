...
const PLANS: {
  ...
  },
  {
    ...
    price:      '₱499/mo',
    priceNum:   499,
    features:   ['₱20/day withdrawal limit', '20 correct answers to withdraw', '1 invite per withdrawal', 'Choose your withdrawal amount', 'Priority support'],
  },
  {
    plan:       'gold',
    name:       'Gold',
    ...
    price:      '₱1,299/mo',
    priceNum:   1299,
    features:   ['₱50/day withdrawal limit', 'No quiz required to withdraw', 'No invite required', 'Choose your withdrawal amount', 'Priority support'],
  },
  {
    plan:       'diamond',
    name:       'Diamond',
    ...
    price:      '₱1,999/mo',
    priceNum:   1999,
    features:   ['₱100/day withdrawal limit', 'No credits needed to withdraw', 'No quiz required', 'No invite required', 'Choose your withdrawal amount', 'VIP support'],
  },
];
