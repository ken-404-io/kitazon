...
export default function Dashboard() {
  ...
  useEffect(() => {
    ...
    api.get('/tasks/earnings/recent').then(res => setRecentEarnings(res.data)).catch(() => {});
  }, []);
  ...
  return (
    <div className="page-container">
      <div className={styles.header}>
        ...
        <Link to="/withdraw"><button className="btn-primary">Withdraw ₱{parseFloat(stats?.balance || 0).toFixed(2)}</button></Link>
      </div>
