...
import { Skeleton, SkeletonReferralEntry } from '../components/ui/Skeleton';
    ...
    <div className={styles.page}>
      ...
      <div className={`card ${styles.statsCard}`}>
        <div className={styles.stat}>
          ...
          <div>
            {loading ? <Skeleton height={28} width={60} /> : <p className={styles.statNum}>{count}</p>}
        ...
        <div className={styles.stat}>
          ...
          <div>
            {loading ? <Skeleton height={28} width={80} /> : <p className={styles.statNum}>₱{earnings.toFixed(2)}</p>}
      ...
      <div className={styles.listSection}>
        ...
        {loading ? (
          <div style={{ display: 'flex', flexDirection: 'column', gap: 4 }}>
            {Array.from({ length: 4 }).map((_, i) => <SkeletonReferralEntry key={i} />)}
          </div>
        ) : referrals.length === 0 ? (
