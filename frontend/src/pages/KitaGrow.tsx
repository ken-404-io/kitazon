...
/* ── Icons (Feather-style line icons, matching the rest of the app) ────────── */
const ic = { viewBox: '0 0 24 24', fill: 'none', stroke: 'currentColor', strokeWidth: 2, strokeLinecap: 'round' as const, strokeLinejoin: 'round' as const };
const ShieldCheckIcon = () => <svg width={22} height={22} {...ic}><path d="M12 22s8-4 8-10V5l-8-3-8 3v7c0 6 8 10 8 10z"/><path d="m9 12 2 2 4-4"/></svg>;
const TrendingUpIcon  = () => <svg width={22} height={22} {...ic}><polyline points="23 6 13.5 15.5 8.5 10.5 1 18"/><polyline points="17 6 23 6 23 12"/></svg>;
const CalendarIcon    = () => <svg width={22} height={22} {...ic}><rect x="3" y="4" width="18" height="18" rx="2"/><line x1="16" y1="2" x2="16" y2="6"/><line x1="8" y1="2" x2="8" y2="6"/><line x1="3" y1="10" x2="21" y2="10"/></svg>;
const ClockIcon       = () => <svg width={22} height={22} {...ic}><circle cx="12" cy="12" r="10"/><polyline points="12 6 12 12 16 14"/></svg>;
const UsersIcon       = () => <svg width={22} height={22} {...ic}><path d="M17 21v-2a4 4 0 0 0-4-4H5a4 4 0 0 0-4 4v2"/><circle cx="9" cy="7" r="4"/><path d="M23 21v-2a4 4 0 0 0-3-3.87"/><path d="M16 3.13a4 4 0 0 1 0 7.75"/></svg>;
const CameraIcon      = () => <svg width={20} height={20} {...ic}><path d="M23 19a2 2 0 0 1-2 2H3a2 2 0 0 1-2-2V8a2 2 0 0 1 2-2h4l2-3h6l2 3h4a2 2 0 0 1 2 2z"/><circle cx="12" cy="13" r="4"/></svg>;
const CheckIcon       = () => <svg width={30} height={30} {...ic}><polyline points="20 6 9 17 4 12"/></svg>;
const LeafIcon        = () => <svg width={150} height={150} {...ic}><path d="M11 20A7 7 0 0 1 9.8 6.1C15.5 5 17 4.48 19 2c1 2 2 4.18 2 8 0 5.5-4.78 10-10 10Z"/><path d="M2 21c0-3 1.85-5.36 5.08-6"/></svg>;
...
const WHY = [
  { icon: <ShieldCheckIcon />, title: 'Safe & Secure', desc: 'Your funds are protected.' },
  { icon: <TrendingUpIcon />,  title: 'Attractive Returns', desc: 'Higher returns for longer terms.' },
  { icon: <CalendarIcon />,    title: 'Flexible Terms', desc: 'Choose the plan that fits you.' },
  { icon: <ClockIcon />,       title: 'On-Time Payouts', desc: 'Payouts processed on time.' },
  { icon: <UsersIcon />,       title: 'Trusted Platform', desc: 'Backed by thousands of Kitazon users.' },
];
  ...
  return (
    <div className={styles.kg}>
      ...
      <header className={styles.hero}>
        <span className={styles.leaf}><LeafIcon /></span>
          ...
          <>
            ...
            <div className={styles.field}>
              ...
              <label className={styles.uploadBox}>
                ...
                {screenshot ? <img className={styles.uploadPreview} src={screenshot} alt="receipt" /> : <><CameraIcon /> Tap to attach receipt</>}
              </label>
            </div>
